import {
  ...
  getPlayerScoreIndex,
} from "../src/PlayMatch/getPlayerPositions";
...
describe("player positions functions", () => {
  describe("getPlayerPositionIndex", () => {
    it("should return 0 for me", () => {
      const myPositionIndex = getPlayerPositionIndex("me", "me", [
        getOtherPlayer("other"),
      ]);
      expect(myPositionIndex).toBe(0);
    });
    it("should return otherPlayers in order", () => {
      const otherPlayerPositionIndex = getPlayerPositionIndex("other", "me", [
        getOtherPlayer("another"),
        getOtherPlayer("other"),
      ]);
  ...
  describe("getPlayerScoreIndex", () => {
    describe("when not team game it should return the player position index", () => {
      it("should return 0 for me", () => {
        const playerScoreIndex = getPlayerScoreIndex("me", "me", [
          getOtherPlayer("other"),
        ]);
        expect(playerScoreIndex).toBe(0);
      });
      it("should return otherPlayers in order", () => {
        const otherPlayerScoreIndex = getPlayerScoreIndex("other", "me", [
          getOtherPlayer("another"),
          getOtherPlayer("other"),
        ]);
    ...
    describe("team game", () => {
      const otherPlayers = [
        getOtherPlayer("otherteam1"),
        getOtherPlayer("teammate"),
        getOtherPlayer("otherteam2"),
      ];
      const getTeamPlayerScoreIndex = (playerId: string) =>
        getPlayerScoreIndex(playerId, "me", otherPlayers);
      it("should return 0 for me", () => {
