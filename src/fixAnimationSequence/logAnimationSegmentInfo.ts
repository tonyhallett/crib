...
export function logAnimationSegmentInfo(animationSegmentInfo: AnimationSegmentInfo) {
  if( animationSegmentInfo.elementKeyTotalTime !== undefined){
    const totalTimeElement = animationSegmentInfo.elementKeyTotalTime.element.className;
    console.log("---------------------------------");
    console.log(`elementKeyTotalTime ${totalTimeElement}, key ${animationSegmentInfo.elementKeyTotalTime.key} `);
  } else{
  ...
  console.log(`start time ${animationSegmentInfo.startTime}, total duration ${animationSegmentInfo.totalDuration}`);
