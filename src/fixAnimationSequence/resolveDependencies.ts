...
import { AnimationSegmentInfo, NewResolvedAnimationDefinitions, ElementAnimationDefinition } from "./createAnimationsFromSegments";
...
export function resolveDependencies(
    ...
    animationSegmentInfos.forEach((animationSegmentInfo) => {
        if (animationSegmentInfo.dependency === undefined || force) {
            ...
            animationSegmentInfo.elementValueInfoMap.forEach((elementValueInfo, element) => {
                ...
                if (animationSegmentInfo.dependent !== undefined && element === animationSegmentInfo.elementKeyTotalTime.element) {
